...
def get_model(config, num_classes, edge_num_classes):
    ...
    if config.model == 'SAGE':
        ...
        edge_pred_features = int((math.log2(get_config('preprocessing').FEATURES.num_polar_bins) + num_classes)*2)

        model = E2E(node_classes = num_classes, 
                    edge_classes = edge_num_classes, 
